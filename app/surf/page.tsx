  ...
  return (
    <div className='pb-24 md:px-6 bg-gradient-to-b from-transparent to-blue-200/30 dark:from-black  dark:to-gray-700 w-screen'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 md:gap-4 md:px-4 mt-24'>
              ...
              <div key={item._id} className='px-4'>
                <div className=''>
                  <Image
                    ...
                    width={1000}
                    height={800}
                    className='mx-auto aspect-[16/9] pb-4'
                  />
                </div>
        ...
        <div className='px-4 md:px-0 bg-gradient-to-b md:bg-gradient-to-r from-blue-200/20 to-transparent md:border-l-2 md:border-t-2 md:border-blue-200/50'>
